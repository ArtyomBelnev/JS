...
// Возвращает видимое и скрытое текстовое содержимое block - со всеми пробелами и переносами строк
// Как правило, сохраняется в переменную для дальнейшего манипулирования
...
// Возвращает только видимое текстовое содержимое block - только с переносами строк
// Как правило, сохраняется в переменную для дальнейшего манипулирования
// Если у block есть дочерние элементы - возвращается текстовое содержимое block и дочерних элементов
block.innerText;
...
// Устанавливает новый текст в block
// При этом перезаписывается всё предыдущее html и текстовое содержимое block
block.innerText = 'Привет';

// Добавляет в конец имеющегося текста новый
// При этом имеющийся текст сохраняется, а вот теги, его оборачивавшие - нет
// Вместо переносов строк вставляется тег br
block.innerText += 'Привет';
